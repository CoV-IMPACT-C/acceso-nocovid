...
<br><center><p style="line-height: 2em;" ><font size="4"><span style="color: #033C73">
**¿Cuál ha sido el impacto de la pandemia en el acceso a atenciones de salud?**<br>
**Un análisis para la adaptación de nuestro sistema de salud** <br>
**MOVID-19** <br></span></font>
<span style="color: #343a40"><font size="2">Viernes 2 de
octubre, 2020</font> </span>
...
knitr::include_graphics("output/graphs/figura_1.png")
```
...
<center>
```{r, out.width = "80%",echo=F, cache=T}
knitr::include_graphics("output/graphs/figura_2.png")
```
...
<center>
```{r, out.width = "80%",echo=F, cache=T}
knitr::include_graphics("output/graphs/figura_3.png")
```
...
<center>
```{r, out.width = "80%",echo=F, cache=T}
knitr::include_graphics("output/graphs/figura_4.png")
```
...
</center><br><font size="2"><p style="line-height: 1em;">*Tabla 1*. Barreras reportadas para no acceder ante un nuevo problema de salud (n= 3.942 individuos) o control crónico desde Marzo a la fecha (n= 3.595 individuos). Las personas pueden marcar múltiples alternativas, por lo que los porcentajes no suman 100%. </font></p>
<br><br></left>
...
**Puedes acceder [a este informe](https://movid19.cl/publicaciones/acceso01/) y más [Publicaciones](https://movid19.cl/publicaciones)**
